...
MODEL_FILENAME = os.path.join(BASE_DIR, 'random_forest_model.pkl')
VECTORIZER_FILENAME = os.path.join(BASE_DIR, 'tfidf_vectorizer.pkl')
...
JADX_TIMEOUT = int(os.getenv('MOBSF_JADX_TIMEOUT', 18000))
# ===========================
...
if CONFIG_HOME:
    ...
    # ANALYZER_IDENTIFIER = os.getenv('MOBSF_ANALYZER_IDENTIFIER', '172.20.10.4:5555')
    ...
    PROXY_PORT = os.getenv('MOBSF_PROXY_PORT', '')
    # ===================================================
    ...
    UPSTREAM_PROXY_IP = os.getenv('MOBSF_UPSTREAM_PROXY_IP', '')
    UPSTREAM_PROXY_PORT = int(os.getenv('MOBSF_UPSTREAM_PROXY_PORT', ''))
