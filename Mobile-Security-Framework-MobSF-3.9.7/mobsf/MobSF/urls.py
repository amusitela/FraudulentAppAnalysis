...
urlpatterns = [
    # REST API
    re_path(r'^api/v1/get_blacklist$', api_sz.get_blacklist),
    ...
    re_path(r'^api/v1/dynamic/my_analysis$', api_dz.my_analysis),
    re_path(r'^api/v1/dynamic/download_txt$', api_dz.send_txt_file),
    re_path(r'^api/v1/dynamic/take_screen$', api_dz.take_screen),
    re_path(r'^api/v1/dynamic/auto_capture$', api_dz.auto_capture),
    re_path(r'^api/v1/dynamic/start_capture$', api_dz.start_capture),
    re_path(r'^api/v1/dynamic/end_capture$', api_dz.end_capture),
    re_path(r'^api/v1/dynamic/hand_analysis$', api_dz.hand_analysis),
